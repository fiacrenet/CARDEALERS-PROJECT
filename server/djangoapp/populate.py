...
def initiate():
    car_make_data = [
        {"name":"NISSAN", "description":"Great cars. Japanese technology","countryorigin":"Japan"},
        {"name":"Mercedes", "description":"Great cars. German technology","countryorigin":"Germany"},
        {"name":"Audi", "description":"Great cars. German technology", "countryorigin":"Germany"},
        {"name":"Kia", "description":"Great cars. Korean technology", "countryorigin":"Korea"},
        {"name":"Toyota", "description":"Great cars. Japanese technology", "countryorigin":"Japan"},
    ]
